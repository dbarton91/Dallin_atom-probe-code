...
currentdirectory = "/Volumes/BESECProjectArun/Experimental_results/APT/H_study/Deuterium/Mass_Spectra/Pure_Fe"
csvfilename1 = "R31_18091-v02_mass_spec.csv"
csvfilename2 = "R31_18182-v01_mass_spec.csv"

savefilename = "combined" #defaults with .png extension.
...
fig, axes = plt.subplots(nrows=2,ncols=1,sharex=True,figsize=(3.25,3.25))
...
fig.text(-0.18, 0.8, 'Counts Normalized to $^{56}$Fe$^{2+}$', ha='center', va='center', rotation='vertical',fontsize=20)
fig.text(0.4, -0.01, 'Mass-to-Charge-State Ratio [Da]', ha='center', va='center', rotation='horizontal',fontsize=15)
...
plt.subplots_adjust(left=0.1, top=1.5)


fig.text(0.1, 1.55, '(a)', ha='center', va='center', rotation='horizontal',fontsize=20)
fig.text(0.1, 0.8, '(b)', ha='center', va='center', rotation='horizontal',fontsize=20)
