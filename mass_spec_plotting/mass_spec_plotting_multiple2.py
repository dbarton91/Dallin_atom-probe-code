...
currentdirectory = "/Volumes/BESECProjectArun/Experimental_results/APT/H_study/Deuterium/Mass_Spectra/Fe18Cr10Ni"
...
fig.text(0.1, 0.1, '(a)', ha='center', va='center', rotation='horizontal',fontsize=20)
fig.text(0.1, 0.1, '(b)', ha='center', va='center', rotation='horizontal',fontsize=20)
