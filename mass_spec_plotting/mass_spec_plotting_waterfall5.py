...
currentdirectory = "/Volumes/BESECProjectArun/Experimental_results/APT/H_study/H_DR_PR_parameterstudy/Mass_Spectra/Fe18Cr10Ni"
csvfilename1 = "R31_18773_Mass_Spec_DR0.5_PR50.csv"
csvfilename2 = "R31_18773_Mass_Spec_DR0.5_PR200.csv"
csvfilename3 = "R31_18773_Mass_Spec_DR3.0_PR50.csv"
csvfilename4 = "R31_18773_Mass_Spec_DR3.0_PR125.csv"
csvfilename5 = "R31_18773_Mass_Spec_DR3.0_PR200.csv"

savefilename = "Fe18Cr10NiAll5" #defaults with .png extension.
...
#Plot
fig, axes = plt.subplots(nrows=5,ncols=1,figsize=(4,3.25), sharex='col', sharey='row')
...
startvert = 1.60
starthoriz = 0.081
fig.text(starthoriz, startvert, 'p', ha='center', va='center', rotation='horizontal',fontsize=20)
fig.text(starthoriz, startvert-falldown, 'q', ha='center', va='center', rotation='horizontal',fontsize=20)
fig.text(starthoriz, startvert-falldown*2, 'r', ha='center', va='center', rotation='horizontal',fontsize=20)
fig.text(starthoriz, startvert-falldown*3, 's', ha='center', va='center', rotation='horizontal',fontsize=20)
fig.text(starthoriz, startvert-falldown*4, 't', ha='center', va='center', rotation='horizontal',fontsize=20)
